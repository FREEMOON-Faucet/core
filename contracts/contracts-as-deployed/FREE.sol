...
contract FREE is Controller, FRC759 {

    constructor (string memory _name, string memory _symbol, uint8 _decimals, uint256 _maxSupply) FRC759(_name, _symbol, _decimals, _maxSupply) {}
